...
Entries are versioned: `wiki/logs/{Major}/{Minor}/{Patch}/CHANGELOG.md`, matching `version`
in `package.json`.
...
|---|---|---|
| [`0/0/0`](../../wiki/logs/0/0/0/CHANGELOG.md) | Pre-release. The agent instruction system, and the web panel built up task by task. | `CHANGELOG.md` |
