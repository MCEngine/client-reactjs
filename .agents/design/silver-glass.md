---
name: design-silver-glass
description: Silver Glass — the white, silver and transparent design system: tokens, the glass recipe, the component vocabulary, and the accessibility checklist.
---

> **How this repository applies it:** Silver Glass is written to be portable, and two of its
> sections describe a static documentation site rather than a single-page application — §6, the
> runtime include system, and §7, the CSS file organization. Neither is implemented here.
> [`panel-application.md`](panel-application.md) records what replaces them. Everything else on
> this page applies unchanged and is binding.
